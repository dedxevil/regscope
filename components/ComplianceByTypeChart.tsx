        ...
        <div className="space-y-4">
            {data.map(item => {
             ...
             <div className="flex justify-end space-x-4 pt-2 text-xs">
                ...
                <div className="flex items-center"><span className="w-3 h-3 rounded-full mr-1.5" style={{backgroundColor: COLORS.nonCompliant}}></span><span className="text-gray-600 dark:text-spotify-gray">Non-Compliant</span></div>
